...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Com.Syncfusion.Rotator.AnimatorListener, Syncfusion.SfRotator.Android", AnimatorListener.class, __md_methods);
	}
	...
	public AnimatorListener ()
	{
		...
		if (getClass () == AnimatorListener.class)
			mono.android.TypeManager.Activate ("Com.Syncfusion.Rotator.AnimatorListener, Syncfusion.SfRotator.Android", "", this, new java.lang.Object[] {  });
	}

	public AnimatorListener (md57a658f92819343e8f910aea51a84e84f.ImageHolder p0)
	{
		super ();
		if (getClass () == AnimatorListener.class)
			mono.android.TypeManager.Activate ("Com.Syncfusion.Rotator.AnimatorListener, Syncfusion.SfRotator.Android", "Com.Syncfusion.Rotator.ImageHolder, Syncfusion.SfRotator.Android", this, new java.lang.Object[] { p0 });
	}
